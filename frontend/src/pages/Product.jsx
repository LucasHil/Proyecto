        ...
        <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
          ...
          {/* Product Information */}
            <div className='flex-1'>
              ...
              <button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white px-8 py-3 text-sm font-medium active:bg-gray-600 rounded-full'>ADD TO CART</button>
